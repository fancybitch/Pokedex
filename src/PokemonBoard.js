      ...
      {selectedPokemon ? (
        ...
        <div className="pokemon-board">
          {pokemonList.map((pokemon) => (
            <Link to={`/Pokedex/${pokemon.number}`} key={pokemon.number} className="pokemon-card" onClick={() => handlePokemonClick(pokemon)}>
  ...
  return (
    <div>
      {selectedPokemon ? (
        ...
        <div className="pokemon-board">
        {pokemonList.map((pokemon) => (
    <Link to={`/Pokedex/${pokemon.number}`} key={pokemon.number}>
